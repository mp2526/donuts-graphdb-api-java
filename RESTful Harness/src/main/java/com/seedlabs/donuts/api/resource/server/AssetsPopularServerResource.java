...
import com.seedlabs.donuts.api.resource.AssetsPopularResource;
...
public class AssetsPopularServerResource extends AbstractServerResource implements AssetsPopularResource {
    ...
    public ArrayList<Asset> represent() throws Exception {
        ...
        try {
            ...
            result = AssetService.getPopularAssets(getApplication().getTitanGraph(), userId, fields);

...
import com.seedlabs.donuts.api.resource.AssetsRecentResource;
...
public class AssetsRecentServerResource extends AbstractServerResource implements AssetsRecentResource {
    ...
    public ArrayList<Asset> represent() throws Exception {
        ...
        try {
            ...
            result = AssetService.getRecentAssets(getApplication().getTitanGraph(), userId, fields);
